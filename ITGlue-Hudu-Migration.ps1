...
if ($null -ne $CurrentVersion -or $CurrentVersion -lt ([version]"2.44.0")) { write-host "Current Hudu version $CurrentVersion is below the required version 2.45.0" -ForegroundColor Red; exit 1 }
